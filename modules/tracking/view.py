...
def issue_book():
    ...
    if book_id is not None and issue_form.validate():
        ...
        msg = f"Book assigned to {user.id}."

        return f"""
        <tr class="fade" id="issue_feedback_{ book_id }>
            ...
            <span class="alert alert-success" role="alert">
                <svg width="50" height="40" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
                <span>{msg}</span>
            </span>
        </tr>
        """
    ...
    <tr class="fade" id="issue_feedback_{ book_id }>
        ...
        <span class="alert alert-warning" role="alert">
            <svg width="50" height="40" role="img" aria-label="Warning:"><use xlink:href="#exclamation-triangle-fill"/></svg>
            <span>{msg}</span>
        </span>
    </tr>
    """
